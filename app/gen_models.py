...
class Character:
    ...
    description: Optional[str] = field(default=None, metadata={'sa': Column(String(2056))})

    work: List[Work] = field(default_factory=list, metadata={'sa': relationship('Work', secondary='shakespeare.character_work', back_populates='character')})
    paragraph: List[Paragraph] = field(default_factory=list, metadata={'sa': relationship('Paragraph', back_populates='character')})
...
class Work:
    ...
    character: List[Character] = field(default_factory=list, metadata={'sa': relationship('Character', secondary='shakespeare.character_work', back_populates='work')})
    chapter: List[Chapter] = field(default_factory=list, metadata={'sa': relationship('Chapter', back_populates='work')})
    paragraph: List[Paragraph] = field(default_factory=list, metadata={'sa': relationship('Paragraph', back_populates='work')})
...
class Chapter:
    ...
    id: int = field(metadata={'sa': Column(Integer)})
    work_id: str = field(metadata={'sa': Column(ForeignKey('shakespeare.work.id'), nullable=False)})
    ...
    work: Optional[Work] = field(default=None, metadata={'sa': relationship('Work', back_populates='chapter')})
    paragraph: List[Paragraph] = field(default_factory=list, metadata={'sa': relationship('Paragraph', back_populates='chapter')})
...
class Paragraph:
    ...
    character_id: str = field(metadata={'sa': Column(ForeignKey('shakespeare.character.id'), nullable=False)})
    ...
    character: Optional[Character] = field(default=None, metadata={'sa': relationship('Character', back_populates='paragraph')})
    chapter: Optional[Chapter] = field(default=None, metadata={'sa': relationship('Chapter', back_populates='paragraph')})
    work: Optional[Work] = field(default=None, metadata={'sa': relationship('Work', back_populates='paragraph')})
